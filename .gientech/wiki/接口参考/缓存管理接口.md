...
| 失效类型 | 触发场景 | 失效范围 |
|----------|---------|----------|
| 租户失效 | 租户数据变更 | 指定租户的所有缓存 |
| 文档失效 | 文档向量变更 | 指定文档相关的所有缓存 |
| 全部失效 | 系统维护/紧急清理 | 所有 RAG 缓存 |
...
**来源**: [CacheManageController.java](../../../company-rag-web/src/main/java/com/company/rag/web/controller/CacheManageController.java)(L22-L27)
...
**来源**: [CacheManageController.java](../../../company-rag-web/src/main/java/com/company/rag/web/controller/CacheManageController.java)(L32-L37)
...
**来源**: [RagCacheManager.java](../../../company-rag-rag/src/main/java/com/company/rag/rag/cache/RagCacheManager.java)(L43-L65)
...
**来源**: [RagCacheManager.java](../../../company-rag-rag/src/main/java/com/company/rag/rag/cache/RagCacheManager.java)(L94-L112)
...
**实现要点**：
- 使用 `contains()` 模糊匹配包含文档 ID 的缓存 Key
- 支持文档向量变更时的精确失效
- 避免全量遍历，仅匹配相关 Key

**来源**: [RagCacheManager.java](../../../company-rag-rag/src/main/java/com/company/rag/rag/cache/RagCacheManager.java)(L71-L89)
...
**实现要点**：
- 使用独立的计数 Key 存储访问次数
- 计数 Key 前缀：`company:rag:rate_limit:hot:`
- 阈值设定为 3 次，超过即判定为热点
- 热点缓存 TTL 延长至 30 分钟（普通缓存为 5 分钟）

**来源**: [RagCacheManager.java](../../../company-rag-rag/src/main/java/com/company/rag/rag/cache/RagCacheManager.java)(L125-L137)
